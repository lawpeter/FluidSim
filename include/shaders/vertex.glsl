const char* vertexShaderSource = R"glsl(
    ...
    void main() {
        particleSpeed = (min(sqrt(dot(particles[gl_InstanceID].velocity, particles[gl_InstanceID].velocity)), 1200.0f) / 1200.0f);
        particleDensity = particles[gl_InstanceID].density;
